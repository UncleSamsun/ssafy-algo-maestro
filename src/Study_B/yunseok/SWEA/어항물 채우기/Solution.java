    ...
    private static boolean run(Scanner sc) throws Exception {
        ...
        for (int q = 0; q < query_num; q++) {
            ...
            if (query == CMD_INIT) {
                ...
                // System.out.println("  ret , ans : " + ret + " " + ans);
                ...
                if (ans != 0 && (ans != ret.ID || ans_height != ret.height || ans_used != ret.used)) {
                    ok = false;
                    // System.out.println("  pret , ans : " + ret.ID + " " + ans);
                    // System.out.println("  used , ans : " + ret.used + " " + ans_used);
                    // System.out.println("  height , ans : " + ret.height + " " + ans_height);
